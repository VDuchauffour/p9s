...
def assign_pools(pve, created_cts):
    print("\n[4/8] Assigning resources to pools...")
    pool_assignments = {
...
def create_sdn(pve, existing):
    print("\n[6/8] Creating SDN zones and VNets...")
    created_sdn = []
    sdn_zones = [
...
def print_summary(created_vms, vms, created_cts, containers, pools, snapshots, created_sdn, created_replication, created_tasks, running_vms):
    print("\n" + "=" * 60)
